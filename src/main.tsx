...
import { installHvscDemoLibraryCleanup } from "./lib/hvsc/hvscDemoLibraryCleanup";
import "./index.css";
...
const startDeferredStartupBootstrap = () => {
  ...
  // App-wide rather than on the Play page: leaving Demo Mode must remove its HVSC library on any page.
  installHvscDemoLibraryCleanup();
