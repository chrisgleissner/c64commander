...
const DOS_STATUS_BY_CODE: Record<number, DosStatusRule> = {
  ...
  73: {
    severity: 'INFO',
    message: 'DOS MISMATCH',
    details: 'This appears after power-up or when write-format compatibility differs between DOS variants. Reading can still work even when writes fail.',
  },
  74: {
    severity: 'WARN',
