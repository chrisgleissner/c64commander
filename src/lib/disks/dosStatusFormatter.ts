...
const DOS_STATUS_BY_CODE: Record<number, DosStatusRule> = {
  0: {
    severity: "INFO",
    message: "OK",
    details: "Drive DOS reports normal operation. No action is needed.",
  },
  1: {
    severity: "INFO",
  ...
  20: {
    ...
    details:
      "The controller could not locate the requested block header. This usually points to a bad block address or damaged media headers.",
  },
  21: {
    severity: "ERROR",
    message: "READ ERROR (No Sync Character)",
    details:
      "No sync mark was detected on the target track. Typical causes are missing or unformatted media, alignment issues, or hardware faults.",
  },
  22: {
    severity: "ERROR",
    message: "READ ERROR (Data Block Not Present)",
    details:
      "The requested data block is missing or was never written correctly. This often appears with invalid direct block requests.",
  },
  23: {
    severity: "ERROR",
    message: "READ ERROR (Checksum Error In Data Block)",
    details:
      "Data was read into memory, but checksum verification failed. Corrupt media or electrical noise are common reasons.",
  },
  24: {
    severity: "ERROR",
    message: "READ ERROR (Byte Decoding Error)",
    details:
      "The drive encountered an invalid bit pattern while decoding bytes. Media defects or signal integrity issues are likely.",
  },
  25: {
    severity: "ERROR",
    message: "WRITE ERROR (Write-Verify Error)",
    details:
      "A verify pass after write did not match DOS memory. Retrying on another disk helps isolate media versus hardware problems.",
  },
  26: {
    severity: "WARN",
  ...
  27: {
    ...
    details:
      "Header checksum validation failed, so the block header is unreliable. This can come from header damage or line noise.",
  },
  28: {
    severity: "ERROR",
    message: "WRITE ERROR (Long Data Block)",
    details:
      "The written block overran timing for the next header sync window. Bad formatting, failing media, or hardware timing faults can trigger this.",
  },
  29: {
    severity: "ERROR",
    message: "DISK ID MISMATCH",
    details:
      "Disk identifier or format metadata does not match what DOS expects. Often seen with uninitialized disks or damaged headers.",
  },
  30: {
    severity: "ERROR",
  ...
  33: {
    ...
    details:
      "Filename or wildcard usage is invalid for the given operation. Use a valid filename pattern for that command.",
  },
  34: {
    severity: "ERROR",
    message: "SYNTAX ERROR (No File Given)",
    details:
      'A command expected a filename but none was supplied. Check separators such as ":" and include a target name.',
  },
  39: {
    severity: "ERROR",
    message: "SYNTAX ERROR (Invalid Command)",
  ...
  65: {
    ...
    message: "NO BLOCK",
    details:
      "The requested block was already allocated. DOS parameters typically point to the next free candidate block.",
  },
  66: {
    severity: "ERROR",
  ...
  71: {
    ...
    details:
      "Directory allocation bookkeeping is inconsistent (BAM mismatch). Reinitialize to rebuild in-memory allocation state.",
  },
  72: {
    severity: "WARN",
    message: "DISK FULL",
    details:
      "Disk blocks or directory slots are exhausted. On 1541, DOS may report full slightly early to reserve close-finalization space.",
  },
  73: {
    severity: "INFO",
    message: "OK",
    details:
      "DOS MISMATCH (power-up status). This is the normal power-on response showing the DOS version. It is not an error, but indicates the drive is ready. If this appears at other times, it may indicate an attempt to write to a disk with an incompatible format.",
  },
  74: {
    severity: "WARN",
