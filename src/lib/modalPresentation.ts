...
const centeredBaseClass =
  "fixed left-[50%] top-[50%] z-50 grid w-[calc(100vw-2*var(--display-profile-modal-inset)-env(safe-area-inset-left)-env(safe-area-inset-right))] max-h-[calc(100dvh-2*var(--display-profile-modal-inset)-env(safe-area-inset-top)-env(safe-area-inset-bottom))] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-y-auto overflow-x-hidden border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg";

const fullscreenBaseClass =
  "fixed inset-[var(--display-profile-modal-inset)] z-50 grid h-[calc(100dvh-2*var(--display-profile-modal-inset)-env(safe-area-inset-top)-env(safe-area-inset-bottom))] w-[calc(100vw-2*var(--display-profile-modal-inset)-env(safe-area-inset-left)-env(safe-area-inset-right))] max-h-[calc(100dvh-2*var(--display-profile-modal-inset)-env(safe-area-inset-top)-env(safe-area-inset-bottom))] max-w-[calc(100vw-2*var(--display-profile-modal-inset)-env(safe-area-inset-left)-env(safe-area-inset-right))] gap-0 overflow-hidden rounded-lg border bg-background p-0 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0";
