...
export const isHandledUiError = (error: unknown) => Boolean((error as ReportableValidationError | undefined)?.c64uHandled);
...
const validateAgainstType = (type: SupportedC64FileType, bytes: Uint8Array) => FileValidatorRegistry.validate(type, bytes);
