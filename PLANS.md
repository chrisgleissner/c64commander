...
- Primary TODO: [ ] Prevent the Licenses close touch from navigating during `pointerup` before the synthetic click sequence can land on the Settings health badge underneath.
