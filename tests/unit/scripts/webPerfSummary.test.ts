        ...
        const summary = summarizeScenarioIterations([
            {
                scenarios: [
                    ...
                    { scenario: 'S8-filter-high-match', wallClockMs: 320, timings: [{ scope: 'playlist:filter', durationMs: 250 }] },
                    { scenario: 'S9-filter-zero-match', wallClockMs: 350, timings: [{ scope: 'playlist:filter', durationMs: 270 }] },
                    { scenario: 'S10-filter-low-match', wallClockMs: 300, timings: [{ scope: 'playlist:filter', durationMs: 220 }] },
                    { scenario: 'S11-playback-start', wallClockMs: 480, timings: [{ scope: 'playback:first-audio', durationMs: 410 }] },
                ],
            },
            {
                scenarios: [
                    ...
                    { scenario: 'S3-enter-hvsc-root', wallClockMs: 450, timings: [{ scope: 'browse:load-snapshot', durationMs: 55 }] },
                    ...
                    { scenario: 'S8-filter-high-match', wallClockMs: 410, timings: [{ scope: 'playlist:filter', durationMs: 280 }] },
                    { scenario: 'S9-filter-zero-match', wallClockMs: 390, timings: [{ scope: 'playlist:filter', durationMs: 290 }] },
                    { scenario: 'S10-filter-low-match', wallClockMs: 330, timings: [{ scope: 'playlist:filter', durationMs: 230 }] },
                    { scenario: 'S11-playback-start', wallClockMs: 520, timings: [{ scope: 'playback:first-audio', durationMs: 430 }] },
                ],
            },
        ]);
