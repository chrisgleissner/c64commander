...
describe("traceBridge", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    // Reset window state
    (window as Window & { __c64uTracing?: unknown; __c64uTestProbeEnabled?: boolean }).__c64uTracing = undefined;
  ...
  it("returns traces via bridge.getTraces", () => {
    ...
    registerTraceBridge();
    const bridge = (window as Window & { __c64uTracing?: { getTraces: () => unknown } }).__c64uTracing!;
  ...
  it("exports traces via bridge.exportTraces", () => {
    ...
    registerTraceBridge();
    const bridge = (window as Window & { __c64uTracing?: { exportTraces: () => Uint8Array } }).__c64uTracing!;
  ...
  it("resets trace ids with defaults via bridge.resetTraceIds", () => {
    registerTraceBridge();
    const bridge = (window as Window & { __c64uTracing?: { resetTraceIds: (a?: number, b?: number) => void } })
      .__c64uTracing!;
  ...
  it("resets trace session with defaults via bridge.resetTraceSession", () => {
    registerTraceBridge();
    const bridge = (window as Window & { __c64uTracing?: { resetTraceSession: (a?: number, b?: number) => void } })
      .__c64uTracing!;
  ...
  it("registers seedTraces when test probe is enabled", () => {
    ...
    const bridge = (window as Window & { __c64uTracing?: { seedTraces?: (e: unknown) => void } }).__c64uTracing!;
  ...
  it("adds seedTraces to existing bridge when test probe is enabled on second call", () => {
    ...
    registerTraceBridge();
    const bridge = (window as Window & { __c64uTracing?: { seedTraces?: unknown } }).__c64uTracing;
    ...
    expect((window as Window & { __c64uTracing?: { seedTraces?: unknown } }).__c64uTracing?.seedTraces).toBeDefined();
  });
