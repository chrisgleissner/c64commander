...
describe('backgroundExecutionManager', () => {
    beforeEach(() => {
        ...
        mocks.classifyError.mockReturnValue({ failureClass: 'plugin-failure', category: 'integration' });
    });
    ...
    it('logs error and throws when background start fails', async () => {
        ...
        await expect(
            startBackgroundExecution({ source: 'playback-controller', reason: 'play' }),
    ...
    it('logs error and throws when background stop fails', async () => {
        ...
        await expect(
            stopBackgroundExecution({ source: 'playback-controller', reason: 'pause' }),
    ...
    it('uses reference counting to avoid duplicate native starts and stops', async () => {
        ...
        await stopBackgroundExecution({ source: 'playback-controller', reason: 'pause' });
