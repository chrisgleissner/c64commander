...
const {
  ...
  mockDismiss: vi.fn(),
  mockToasts: { value: [] as Array<{ id: string; title?: string; description?: string; action?: React.ReactElement }> },
...
vi.mock('@/components/ui/toast', () => ({
  ...
  ToastTitle: vi.fn(({ children }: { children?: React.ReactNode }) => (
  ...
  ToastProvider: vi.fn(
    ({ children, duration }: { children?: React.ReactNode; duration?: number }) => (
