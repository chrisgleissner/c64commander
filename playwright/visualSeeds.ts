...
export const DISK_LIBRARY_SEED = [
  ...
  {
    id: "ultimate:/Usb0/Games/Sample Quest/Disk 1.d64",
    name: "Disk 1.d64",
    path: "/Usb0/Games/Sample Quest/Disk 1.d64",
    location: "ultimate",
    group: "Sample Quest",
    sizeBytes: 174848,
  ...
  {
    id: "local:/Local/Disks/Sample Chronicle.d64",
    name: "Sample Chronicle.d64",
    path: "/Local/Disks/Sample Chronicle.d64",
    location: "local",
    group: null,
    sizeBytes: 174848,
  ...
  {
    id: "local:/Local/Disks/Sample Sisters.d64",
    name: "Sample Sisters.d64",
    path: "/Local/Disks/Sample Sisters.d64",
    location: "local",
    group: null,
    sizeBytes: 174848,
...
export const PLAYLIST_SEED = {
  items: [
    ...
    {
      source: "ultimate",
      path: "/Usb0/Games/SampleShuttle.d64",
      name: "SampleShuttle.d64",
      durationMs: 300000,
      sizeBytes: 174848,
...
const buildTraceSeed = (): TraceEvent[] => {
  ...
  const scenarios: SeedScenario[] = [
    ...
    createFtpScenario({
      ...
      restDurationMs: 92,
      ftpOperation: "RETR",
      ftpPath: "/Usb0/Games/SampleArcade_II/loader.prg",
      ftpDurationMs: 214,
    }),
    createFtpScenario({
      minutesAgo: 120,
      ...
      restDurationMs: 68,
      ftpOperation: "SIZE",
      ftpPath: "/Usb0/Games/Sample Arcade/Disk 1.d64",
      ftpDurationMs: 138,
    }),
    createFtpScenario({
      minutesAgo: 114,
