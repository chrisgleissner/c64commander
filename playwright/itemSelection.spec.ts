...
test.describe("Item Selection Dialog UX", () => {
  ...
  test("Play page: Add folder returns to Play and populates playlist", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
    await page.goto("/play");
    await snap(page, testInfo, "play-initial");
  ...
  test("Disks page: Add folder returns to Disks and populates library", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
  ...
  test("Play page: repeated add items via folder picker remains stable", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
    await page.goto("/play");
    await snap(page, testInfo, "play-initial");
  ...
  test("Disks page: repeated add items via folder picker remains stable", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
    await page.goto("/disks");
    await snap(page, testInfo, "disks-initial");
  ...
  test("Play page: repeated add items via C64 Ultimate remains stable", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
    await page.goto("/play");
    await snap(page, testInfo, "play-initial");
  ...
  test("Disks page: repeated add items via C64 Ultimate remains stable", async ({
    page,
  }: { page: Page }, testInfo: TestInfo) => {
    await page.goto("/disks");
    await snap(page, testInfo, "disks-initial");
