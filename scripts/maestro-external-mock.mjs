...
import { loadMockTimingProfile, resolveMockTimingClassId, resolveMockTimingDelayMs } from "./lib/mockTimingProfile.mjs";
import { loadDeviceConfigFixture } from "./lib/deviceConfigFixture.mjs";
...
const { categories, configs } = loadDeviceConfigFixture();
const requests = [];
