...
const featureRows = ({ features, variant }) => {
  ...
  rows.push(["Case and keyboard lights", "**Home → Lighting**, Config", "Shown for machines that have them."]);
