          ...
          ...(includeFeature(features, "video_mirror_enabled")
            ? [
                ...
                `When you steer your ${appDeviceName(
                  variant,
                )} with a physical keypad, those same keys could drive the C64 or move the picture, so Live View makes the difference impossible to mistake. The mirror wears a coloured border that tells you at a glance which one you are doing: a **blue “Driving C64”** border means your keys go straight to the machine, as usual; an **amber “Adjusting view”** border means your keys zoom and pan the picture instead.`,
                "",
...
const INDEX_TERMS = [
  ...
  { term: "tunes, choosing", match: ["Tune 1 of 19"] },
