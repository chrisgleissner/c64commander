...
| Physical HIL           | Production evidence                                       | `docs/testing/physical-device-matrix.md`, agentic docs | `node scripts/run-pixel4-c64u-soak.mjs`, `npm run startup:baseline`, `scope:hil:evidence`, app-first droidctl/c64scope/c64bridge runs                 | Manual/HIL                         | Pixel 4 + real C64U                  | c64scope timelines, screenshots, logcat, app diagnostics, A/V assertions    | Long                    | real networking, safety, A/V                                  | CI-only repeatability                        |
