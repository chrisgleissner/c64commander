...
| F9  | C     | **open, unfinished**  | After 200 random keys the Play page rendered **completely blank** — tab bar and guidance only, textLen 64 vs 587 healthy, focusables 6 vs 50. Recovers on any tab press. Reproduction so far: 10 rounds rapid page-jumping (0), 5 rounds identical 200-key mash (0), 2 of a planned 15 more (0) before device handover. **Not at the 20-round bar — incomplete, not concluded.** Needs a device (Game Mode entry).                                                                                                                                    | **resume on u64**           |
...
| F16 | C     | works                 | With no network the app degrades well — a clear "No C64 systems found" prompt with a host/IP field, not a blank or stuck screen.                                                                                                                                                                                                                                                                                                                                                                                                                      | confirmed                   |
...
1. **F9** — finish to 20 mash rounds (needs u64 for Game Mode entry).
