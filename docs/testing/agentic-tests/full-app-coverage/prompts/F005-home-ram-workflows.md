# F005 Home RAM dump/load/clear workflows

## Feature Under Test

Home RAM dump/load/clear workflows
...
1. Start a `c64scope` session with caseId `F005` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- RAM dump folder is configured and visible.
- Save RAM produces file artifact.
- Load RAM and clear RAM actions complete with expected state.
...
- Evidence set is complete and mapped to `F005`.
