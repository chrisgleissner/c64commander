# F014 Songlength, default duration, and subsong selector

## Feature Under Test

Songlength, default duration, and subsong selector
...
1. Start a `c64scope` session with caseId `F014` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Duration slider/input updates effective duration.
- Songlength file load is reflected in metadata.
- Subsong selector changes active subsong.
...
- Evidence set is complete and mapped to `F014`.
