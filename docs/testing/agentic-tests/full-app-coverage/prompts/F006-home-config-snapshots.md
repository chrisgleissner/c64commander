# F006 Home app config snapshot save/load/rename/delete

## Feature Under Test

Home app config snapshot save/load/rename/delete
...
1. Start a `c64scope` session with caseId `F006` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Save creates named snapshot.
- Load applies selected snapshot.
- Rename/delete update list deterministically.
...
- Evidence set is complete and mapped to `F006`.
