# F020 Settings connection/theme/preferences/HVSC toggle

## Feature Under Test

Settings connection/theme/preferences/HVSC toggle
...
1. Start a `c64scope` session with caseId `F020` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Host/password/theme/prefs changes persist.
- Save & Connect behaves as expected.
- HVSC toggle state is reflected on Play availability.
...
- Evidence set is complete and mapped to `F020`.
