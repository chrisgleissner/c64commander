# F007 Disks library add/group/rename/delete

## Feature Under Test

Disks library add/group/rename/delete
...
1. Start a `c64scope` session with caseId `F007` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Add disks imports selected entries.
- Group/rename operations update rows correctly.
- Delete operations remove only selected entries.
...
- Evidence set is complete and mapped to `F007`.
