# F010 Play source browsing for Local/C64U/HVSC

## Feature Under Test

Play source browsing for Local/C64U/HVSC
...
1. Start a `c64scope` session with caseId `F010` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Add-items source chooser opens and lists sources.
- Folder navigation works in each enabled source.
- Entry selection state is deterministic.
...
- Evidence set is complete and mapped to `F010`.
