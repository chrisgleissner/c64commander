# F011 Playlist create/edit/remove/clear lifecycle

## Feature Under Test

Playlist create/edit/remove/clear lifecycle
...
1. Start a `c64scope` session with caseId `F011` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Adding items increases playlist as expected.
- Remove selected and clear actions update counts exactly.
- Playlist list remains consistent after refresh.
...
- Evidence set is complete and mapped to `F011`.
