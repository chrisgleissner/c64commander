# F008 Disk mount/eject to Drive A and Drive B

## Feature Under Test

Disk mount/eject to Drive A and Drive B
...
1. Start a `c64scope` session with caseId `F008` and artifact root under `/home/chris/dev/c64/c64commander/docs/testing/agentic-tests/full-app-coverage/runs/`.
...
- Mount action updates drive row and status.
- Eject clears mounted state.
- Drive A/B targeting is correct.
...
- Evidence set is complete and mapped to `F008`.
