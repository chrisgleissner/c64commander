...
- Initialized autonomous execution run from `doc/research/review-3/IMPLEMENTATION-PLAN.md`.
- Read mandatory inputs: `AGENTS.md`, `.github/copilot-instructions.md`, `REPORT.md`, `tables/risk-register.md`.
- Created required evidence structure under `doc/research/review-3/post-fix/` (`logs/`, `metrics/`, `tables/`, `screenshots/`).
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-0-baseline.log`.
- Baseline summary: `doc/research/review-3/post-fix/metrics/phase-0-baseline-summary.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-2-playwright.log`.
- Summary: `doc/research/review-3/post-fix/metrics/phase-2-playwright-summary.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-1-android-jvm.log`.
- Summary: `doc/research/review-3/post-fix/metrics/phase-1-android-jvm-summary.md`.
...
- Evidence:
  - Log: `doc/research/review-3/post-fix/logs/phase-3-web-opt.log`.
  - Bundle delta: `doc/research/review-3/post-fix/tables/bundle-delta.md`.
  - Runtime metrics: `doc/research/review-3/post-fix/metrics/docker-constrained-after.txt` and `doc/research/review-3/post-fix/metrics/docker-constrained-delta.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-4-web-server.log`.
- Coverage delta table: `doc/research/review-3/post-fix/tables/web-server-coverage-delta.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-5-lifecycle.log`.
- Parity matrix: `doc/research/review-3/post-fix/tables/platform-parity-matrix.md`.
...
- Phase 6: ran targeted layout/readability suites for phone+tablet projects.
  - Evidence log: `doc/research/review-3/post-fix/logs/phase-6-ui.log`.
  - Summary: `doc/research/review-3/post-fix/metrics/phase-6-ui-summary.md`.
- Phase 7: executed constrained endurance loops (web + Android).
  ...
  - Evidence log: `doc/research/review-3/post-fix/logs/phase-7-endurance.log`.
  - Metrics: `doc/research/review-3/post-fix/metrics/endurance-web.md`, `doc/research/review-3/post-fix/metrics/endurance-android.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-8-maestro.log`.
- Stability table: `doc/research/review-3/post-fix/tables/maestro-stability-report.md`.
...
- Evidence log: `doc/research/review-3/post-fix/logs/phase-9-final-gate.log`.
...
- Added compact PR-ready changelog: `doc/research/review-3/post-fix/PR-READY-CHANGELOG.md`.
