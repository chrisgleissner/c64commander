...
Crossfading only works for tunes playing on your phone. Two tunes have to sound at the same moment for one to fade into the other, and the Commodore 64 Ultimate plays a single tune live on its one sound chip — so while **Play on: C64** is selected the setting is greyed out and tunes change cleanly instead.
