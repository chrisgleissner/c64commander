...
- **The device's own name** (or **C64U** if it has none) — the tune plays on the Commodore 64 Ultimate and you listen there. The button is labelled after the machine you are connected to, so with two saved machines you can see which one you are choosing.
