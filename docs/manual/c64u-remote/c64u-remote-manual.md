...
If no devices are found, C64U Remote opens **No C64 found**, a manual setup prompt.
...
The first time you open C64U Remote it offers a short guided walk through the running app rather than through pictures of it. It visits each page, puts a spotlight on what it is describing, and explains it in a line or two.
...
Remote Input turns your phone into a second-screen controller for the C64. It is handy when you are sitting across the room from the machine, when no joystick is plugged in, or when you only want to type a command without reaching for the real keyboard.
...
| Case and keyboard lights | **Home**, Config | Shown for machines that have them. |
