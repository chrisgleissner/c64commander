...
- The run must satisfy a safety margin of at least **92% branch coverage** (global), even if CI thresholds are lower.
- If branch coverage is below 92%, continue adding meaningful tests until it is >= 92%.
