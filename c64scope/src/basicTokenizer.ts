...
export const STREAM_VALIDATION_PROGRAM = [
  ...
  '40 PRINT "BORDER COLOR: RED (2)"',
  '50 PRINT "BACKGROUND COLOR: BLUE (6)"',
  '60 PRINT "SID FREQ: ~440 HZ (REG=7496)"',
  "70 POKE 54296,15",
  "80 POKE 54277,17:POKE 54278,240",
  "90 POKE 54272,72:POKE 54273,29",
  "100 POKE 54276,17",
  "110 GOTO 110",
].join("\n");
