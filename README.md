...
- **Cross-device**: Works with any network-capable Ultimate running firmware 3.11 or newer (which added the HTTP REST API): the Commodore 64 Ultimate, the Ultimate 64 family (Ultimate 64, Elite, Elite-II), and the Ultimate-II+(L) cartridge.
