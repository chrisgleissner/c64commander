# F001 App shell launch + foreground stability

## Feature Under Test

App shell launch + foreground stability
...
- Start route target: `/`
- Dependency features in terminal state: none
...
1. Start a `c64scope` session with caseId `F001` and artifact root under `/home/chris/dev/c64/c64commander/doc/testing/agentic-tests/full-app-coverage/runs/`.
...
- Evidence set is complete and mapped to `F001`.
